...
<p align="left">
  ...
  <img alt="899 tests" src="https://img.shields.io/badge/tests-899-1f8b4c">
</p>
...
899 tests: 399 unit, 236 integration, 92 contract, 172 security.
...
make test-fast        # 899 tests against the running stack, 95% coverage floor
...
MIT, in [`LICENSE`](./LICENSE). A personal portfolio project by Dylan Bermudez Cardona.
